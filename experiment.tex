...
Die in diesem Abschnitt aufgeführten Aktivitäten werden hinsichtlich ihrer Bewegungsmuster nur unwesentlich durch Handbewegungen definiert, weshalb diese \textit{nicht-handorientiert} genannt werden.
\subsubsection{Gehen}
